...
(function (t, e) {
    ...
    if (!i.TweenLite) {
        ...
        var z = [], F = {}, L = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, N = function (t) {
                ...
                var l, h, _ = "get" === i ? t[e] : i, u = typeof t[e], f = "string" == typeof s && "=" === s.charAt(1),
                    c = {
                        t: t,
                        p: e,
                        s: _,
            ...
            }, G = I._internals = {isArray: c, isSelector: E, lazyTweens: z, blobDif: U}, Q = I._plugins = {},
            q = G.tweenLookup = {}, B = 0, M = G.reservedProps = {
                ease: 1,
                delay: 1,
                overwrite: 1,
                onComplete: 1,
