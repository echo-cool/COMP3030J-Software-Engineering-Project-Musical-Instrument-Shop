...
urlpatterns = [
    ...
    path('instrument_category_management/', views.instrument_category_management,
         name='instrument_category_management'),
    path('update_instrument_category/<int:category_id>/', views.update_instrument_category,
         name='update_instrument_category'),
    ...
    path('order_state/<int:order_id>', views.order_state, name='order_state'),
